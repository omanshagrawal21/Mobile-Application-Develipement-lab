        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            s1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    n[0] = n[0] +Double.parseDouble(
                            parent.getItemAtPosition(position).toString());
                    e5.setText(String.valueOf(Double.parseDouble(
                            parent.getItemAtPosition(position).toString())*450));
                }
                @Override
            ...
            s2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    n[0] = n[0] +Double.parseDouble(
                            parent.getItemAtPosition(position).toString());
                    e6.setText(String.valueOf(Double.parseDouble(
                            parent.getItemAtPosition(position).toString())*150));
                }
                @Override
                public void onNothingSelected(AdapterView<?> parent) {
            ...
            s3.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    n[0] = n[0] +Double.parseDouble(
                            parent.getItemAtPosition(position).toString());
                    e7.setText(String.valueOf(Double.parseDouble(
                            parent.getItemAtPosition(position).toString())*250));
                }
                @Override
                public void onNothingSelected(AdapterView<?> parent) {
                }
